...
def clear():
    os.system('clear')
def baner():
	print('  \033[033m   _________________      _____   .___ ')
	print('  \033[033m  /   _____/\_____  \    /     \  |   |')
	print('  \033[032m  \_____  \  /   |   \  /  \ /  \ |   |')
	print('  \033[032m  /        \/    |    \/    Y    \|   |')
	print('  \033[030m /_______  /\_______  /\____|__  /|___|')
	print('  \033[030m         \/         \/         \/      ')
...
def login(user,pw,cek=False):
          ...
          if 'EAA' in r.text:
             ...
             die+=1
          for i in list('\|/-•'):
                            print(f"\r\033[00m[\033[1;91m{i}\033[1;92m] Successful : \033[1;92m{str(result)} \033[1;93mcheckpoint : \033[1;96m{str(chek)} \033[1;94mdie : \033[1;95m{str(die)} \033[00m",end="")
                            time.sleep(0.2)

def search():
    knf=input('\t\033[1;97m[\033[96m?\033[1;97m]Query: \033[96m')
