...
def brand_boy():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Attack")
    print("\033[97m [\033[91m00\033[97m] Exit")
    print('\033[1;93m⊰\033[1;91m═════════════════════════════════════════════\033[1;93m⊱')
    time.sleep(0.1)

    brand=input("\x1b[1;97m] \033[90m►\033[1;93m ")
    if brand == "1" or brand =="01":
         ...
         if __name__ == '__main__':
               try:
                   ...
                   aahh('\033[1;97m [\033[1;92m06\033[1;97m] Delete Cookies')
                   aahh('\033[1;97m [\033[1;92m00\033[1;97m] Exit')
                   print('\033[1;93m⊰\033[1;91m═════════════════════════════════════════════\033[1;93m⊱')
                   
                   somi = input('\x1b[1;97m] \033[90m►\033[1;93m ')
                   if somi =="":
